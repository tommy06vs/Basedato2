...
//        panel_informacion.addComponentListener(new MyComponentAdapter());
    ...
    public void initTable(){
        ...
        JButton btnDosPersonasMasAlto = new JButton("+");
        JButton btnDosPersonasMasBajo = new JButton("-");


        lbTitulo.setBounds(315,1,80,25);

        btnDosPersonasMasAlto.setBounds(670, 6, 15, 15);
        btnDosPersonasMasBajo.setBounds(690, 6, 15, 15);
        btnInicio2.setBounds(285,420,60,25);
        btnPerfil2.setBounds(360,420,60,25);

        btnDosPersonasMasAlto.setContentAreaFilled(false);
        btnDosPersonasMasBajo.setContentAreaFilled(false);
        btnDosPersonasMasAlto.setBorder(new LineBorder(new Color(0, 252, 4, 255)));
        btnDosPersonasMasBajo.setBorder(new LineBorder(new Color(0, 252, 4, 255)));
        ...
        btnDosPersonasMasAlto.setMargin(new Insets(0,0,0,0));
        btnDosPersonasMasBajo.setMargin(new Insets(0,0,0,0));

        panel_principal.add(lbTitulo);
        panel_principal.add(btnInicio2);
        panel_principal.add(btnPerfil2);
        panel_principal.add(btnDosPersonasMasAlto);
        panel_principal.add(btnDosPersonasMasBajo);
        ...
        btnVerTabla.addActionListener(e -> {
            ...
            if (listaEstudiantes != null) {
                ...
                btnEliminar.addActionListener(ee -> {
                    int row = tabla.getSelectedRow();
                    if (row >= 0) {
                        int id = Integer.parseInt(codigoIDTextField.getText());
                ...
                btnModifcar.addActionListener(ee -> {
                    int id = Integer.parseInt(codigoIDTextField.getText());
                    String nombre = nombreTextField.getText();
                    int altura = Integer.parseInt(apPaternoTextField.getText());
...
//                        DefaultTableModel model = (DefaultTableModel) tabla.getModel();
        ...
        btnVerTabla2.addActionListener(e -> {
            ...
            if (listaestudianteDto != null && listaestudianteNotaDto != null){
                ...
                btnNuevo2.setBounds(630, 110, 75, 25);
     ...
     *         btnVerTabla2.setMargin(new Insets(0,0,0,0));
     *         JButton btnVerTabla3 = new JButton("Opcion 2");
     *         btnVerTabla3.setBounds(640, 385, 70, 28);
     *         btnVerTabla3.setMargin(new Insets(0,0,0,0));
     *
     *         panel_principal.add(btnVerTabla);
     *         panel_principal.add(btnVerTabla2);
     ...
     *                 JLabel carreraLabel = new JLabel("Carrera:");
     *
     *                 JTextField codigoIDTextField2 = new JTextField();
     *                 JTextField nombreTextField2 = new JTextField();
     *                 JTextField apPaternoTextField2 = new JTextField();
     *                 JTextField apMaternoTextField = new JTextField();
     *                 JTextField dtNacimientoTextField = new JTextField();
     *                 JTextField materiaIDTextField = new JTextField();
     *                 JTextField carreraTextField = new JTextField();
     ...
     *                 JButton btnReset = new JButton("//");
     *
     *                 codigoIDTextField2.setOpaque(false);
     *                 nombreTextField2.setOpaque(false);
     *                 apPaternoTextField2.setOpaque(false);
     *                 apMaternoTextField.setOpaque(false);
     *                 dtNacimientoTextField.setOpaque(false);
     *                 materiaIDTextField.setOpaque(false);
     *                 carreraTextField.setOpaque(false);
     *
     *                 codigoIDLabel.setBounds(10,25,80,25);
     *                 codigoIDTextField2.setBounds(78,24,90,25);
     *                 nombreLabel.setBounds(10,52,90,25);
     *                 nombreTextField2.setBounds(78,51,90,25);
     *                 apPaternoLabel.setBounds(10,78,90,25);
     *                 apPaternoTextField2.setBounds(78,78,90,25);
     *                 apMaternoLabel.setBounds(10,104,90,25);
     *                 apMaternoTextField.setBounds(78,106,90,25);
     *
     *                 dtNacimientoLabel.setBounds(180,25,90,25);
     ...
     *
     *                 panel_principal.add(codigoIDLabel);
     *                 panel_principal.add(codigoIDTextField2);
     *                 panel_principal.add(nombreLabel);
     *                 panel_principal.add(nombreTextField2);
     *                 panel_principal.add(apPaternoLabel);
     *                 panel_principal.add(apPaternoTextField2);
     *                 panel_principal.add(apMaternoLabel);
     *                 panel_principal.add(apMaternoTextField);
     *                 panel_principal.add(dtNacimientoLabel);
     *                 panel_principal.add(dtNacimientoTextField);
     ...
     *                         int row = tabla.getSelectedRow();
     *                         if (row >= 0) {
     *                             codigoIDTextField2.setText(String.valueOf(tabla.getValueAt(row, 0)));
     *                             nombreTextField2.setText(String.valueOf(tabla.getValueAt(row, 1)));
     *                             apPaternoTextField2.setText(String.valueOf(tabla.getValueAt(row, 2)));
     *
     *                             apMaternoTextField.setText(String.valueOf(tabla.getValueAt(row, 3)));
     *                             dtNacimientoTextField.setText(String.valueOf(tabla.getValueAt(row, 4)));
     *                             materiaIDTextField.setText(String.valueOf(tabla.getValueAt(row, 5)));
     ...
     *                 });
     *                 btnNuevo.addActionListener(ee -> {
     *                     String idText = codigoIDTextField2.getText();
     *                     String nombre = nombreTextField2.getText();
     *                     String appaterno = apPaternoTextField2.getText();
     *                     String apmaterno = apMaternoTextField.getText();
     *                     String dtNacimiento = dtNacimientoTextField.getText();
     *                     String materiaId = materiaIDTextField.getText();
     *                     String carrera = carreraTextField.getText();
     ...
     *                         new ConsultaDao().insert(nuevo);
     *
     *                         codigoIDTextField2.setText("");
     *                         nombreTextField2.setText("");
     *                         apPaternoTextField2.setText("");
     *
     *                 });
     *
     *                 btnEliminar.addActionListener(ee -> {
     *                     int row = tabla.getSelectedRow();
     *                     if (row >= 0) {
     *                         int id = Integer.parseInt(codigoIDTextField2.getText());
     *                         new PersonaDao().delete(id);
     *
     *                         // Success: Remove the row from the table
     *                         model.removeRow(row);
     ...
     *                     int id = Integer.parseInt(codigoIDTextField2.getText());
     *                     String nombre = nombreTextField2.getText();
     *                     int altura = Integer.parseInt(apPaternoTextField2.getText());
     *
     *                     PersonaDto updatedPersona = new PersonaDto(id, nombre, altura);
     *
     *                     if (new PersonaDao().update(updatedPersona)) {
    ...
    private void refreshTable() {
        ...
        for (PersonaDto estudiante : personas) {
            Object[] rowData = {estudiante.getId(), estudiante.getNombre(), estudiante.getAltura()};
    ...
    private void displayPersonsList(String title, ListaDoble<PersonaDto> personas) {
        ...
        for (PersonaDto estudiante : personas) {
            sb.append("ID: ").append(estudiante.getId()).append(", Nombre: ").append(estudiante.getNombre()).append(", Altura: ").append(estudiante.getAltura()).append("\n");
        }
...
/*puedes modificar el codigo realizar el mismo metod de mostrar la tabla del boton btnVerTabla.addActionListener() en el metodo
btnVerTabla2.addActionListener() pero con una modificacion: String[] columnNames = {"Codigo_ID", "sNombre", "apPaterno", "dtNacimiento", "Materia_ID", "Carrera"};
no se va implementar la columna "apMaterno", como lo muestra en la primera tabla que muestra la accion del boton
btnVerTabla.addActionListener() que en esa si lo muestra. que cada vez que se le de clic a los dos botones muestre la tabla
si presiono el boton de btnVerTabla2.addActionListener() no me muestre la tabla que tiene btnVerTabla.addActionListener() sino la otra
y viceversa
...
//        this.panel_principal.setSize(500,500);
        ...
        btnVerTabla.addActionListener(e -> {
            ListaDoble<EstudianteDto> listaEstudiantes = new ConsultaDao().getAllEstudiantes();
            if (listaEstudiantes != null) {
                Object[][] data = new Object[listaEstudiantes.tamano()][7];
                String[] columnNames = {"Codigo_ID", "sNombre", "apPaterno", "apMaterno", "dtNacimiento", "Materia_ID", "Carrera"};
                Iterator<EstudianteDto> iterator = listaEstudiantes.iterator();
                int i = 0;
                while (iterator.hasNext()) {
                    EstudianteDto estudiante = iterator.next();
